...
const Cart = () => {
    const {
        ...
        updateCartItems,
        navigate,
        getCartTotalPrice, axios, user, setCartItems
    } = useAppContext();
    ...
    const getCart = () => {
        ...
        setCartArray(tempArray); // ✅ now inside function
    };
    ...
    const getUserAddresses = async () => {
        try {
            ...
            if (data.success && data.addresses.length > 0) {
                ...
                setSelectedAddress(data.addresses[data.addresses.length - 1]); // pick last added
            } else {
                setAddresses([]);
...
const PlaceOrder = async () => {
    ...
    // Fetch cart items when cartItems or products change
    useEffect(() => {
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    <p className="flex justify-between">
                        <span>Price</span>
                        <span>{currency}{getCartTotalPrice()}</span>
                    </p>
                    <p className="flex justify-between">
                    ...
                    <p className="flex justify-between">
                        <span>Tax (2%)</span>
                        <span>{currency}{(getCartTotalPrice() * 2) / 100}</span>
                    </p>
                    <p className="flex justify-between text-lg font-medium mt-3">
                        <span>Total Amount:</span>
                        <span>
                            {currency}
                            {getCartTotalPrice() + (getCartTotalPrice() * 2) / 100}
                        </span>
                    </p>
                </div>
