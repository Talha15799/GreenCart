  ...
  return (
    <div className='relative'> 
        ...
        <div className='flex items-center mt-6 font-medium'>
           <Link to={"/products"}  className='group flex items-center gap-2 text-white bg-primary px-7 md:px-9 py-3 rounded hover:bg-primary-dull transition cursor-pointer'>
           Shop now
           ...
           Explore deals
            <img className='transition group-hover:translate-x-l' src={assets.black_arrow_icon} alt="arrow"/>
            </Link>
        </div>
        </div>
